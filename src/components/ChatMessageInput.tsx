...
import IconSend from "./icons/iconsSend";
...
const handleTextKeyUp = (event: KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    return (
        <div className={`flex border border-gray-800/50 bg-gpt-lightgray p-2 rounded-md ${disabled && 'opacity-50'}`}>
            ...
            <textarea
            ref={textEl}
            className="flex-1 border-0 bg-transparent resize-none outline-none h-7 max-h-48 overflow-y-auto" placeholder="Digite uma mensagem" value={text}
